...
public class DelayO {
    ...
    public DelayO(double startIntegrationValue, double finishIntegrationValue, Function<Double, Double> function, double deltaValue) {
    ...
    public static void main(String[] args) {
        ...
        DelayO delay = new DelayO(0, 0.01, t -> 2.0 * t, 0.001);
