 ...
 *
 */
package persistence.loader._util;
...
//	}
//
//	public _Date(long date) {
//		super(date);
//	}
//
//	public _Date(int year, int month, int date, int hrs, int min, int sec) {
//		super(year - 1900, month, date, hrs, min, sec);
//	}
//
