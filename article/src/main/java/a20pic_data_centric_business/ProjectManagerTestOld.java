package a20pic_data_centric_business;


import main.ProjectManager;
import neural.testold.TransportSystemO;
...
public class ProjectManagerTestOld {
    ...
    public void saveTableDataTest() {
        ...
        TransportSystemO transportSystem = new TransportSystemO(variant);
        ...
        projectManager.saveData(tableTest,"f002.csv", "article\\src\\main\\java\\a20pic_data_centric_business\\result");
